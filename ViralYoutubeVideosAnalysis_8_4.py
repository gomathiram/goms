...
ca_vid = pd.read_csv("C:/Users/Amit/Documents/YouTubeVideoAnalysis/Datasets/CAvideos.csv")
gb_vid = pd.read_csv("C:/Users/Amit/Documents/YouTubeVideoAnalysis/Datasets/GBvideos.csv",  error_bad_lines= False )
us_vid = pd.read_csv("C:/Users/Amit/Documents/YouTubeVideoAnalysis/Datasets/USvideos.csv", error_bad_lines = False)
us_vid.head(3)
